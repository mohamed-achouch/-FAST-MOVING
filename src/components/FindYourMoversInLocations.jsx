...
import "../assets/styles/findyourmover.css";
const FindYourMoversInLocations = () => {
  return (
    <div className="container">
      <div className="find_yourmover">
    
        <h1>Find Your Movers in Locations</h1>
        ...
        <div className="svg">
          ...
          <ul>
            <li>
              {" "}
              San Francisco <span>(19)</span>
            </li>
            <li>
              Oakland <span>(18)</span>
            </li>
            <li>
              San Jose <span>(14)</span>
            </li>
          </ul>
          <ul>
            <li>
...
export default FindYourMoversInLocations;
